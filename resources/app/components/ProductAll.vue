        ...
        <div class="pro-grli-wrap product-grid">
            <div class="collection-img-wrap" data-animate="animate__fadeIn">
                ...
                <div class="collection-info">
                    <div class="collection-image" data-animate="animate__fadeIn" v-if="saleBanner">
                        <img :src="bannerSource" class="img-fluid"
                            alt="sall-banner">
                    </div>
                </div>
                <!-- collection info end -->
            ...
            <div class="shop-top-bar">
                ...
                <div class="product-view-mode">
                    ...
                    <a href="javascript:void(0)" class="list-change-view grid-three active" data-grid-view="3"><i
        ...
        <div class="pro-grli-wrap product-sidebar">
                            ...
                            <form class="facets-form">
                                <div class="facets-wrapper">
                                    ...
                                    <div class="shop-sidebar" data-animate="animate__fadeIn">
                                        <h6 class="shop-title" data-animate="animate__fadeIn">Danh mục</h6>
                                    ...
                                    <div class="shop-sidebar sidebar-filter">
                                        ...
                                        <a href="javascript:void(0)" class="shop-title shop-title-lg">Lọc</a>
                                        <div class="filter-info" data-animate="animate__fadeIn">
                                            <span class="filter-count-text">23 sản phẩm</span>
                                            <span class="loading-spinner"><svg aria-hidden="true" focusable="false"
                                    ...
                                    <div class="shop-sidebar sidebar-price">
                                        ...
                                        <div class="filter-info" data-animate="animate__fadeIn">
                                            ...
                                            <facet-remove><a href="collection.html" class="reset-text">Đặt
                                                    lại</a></facet-remove>
                                        </div>
                                        <!-- Product-price start -->
                                        <div class="collapse price-wrap" id="collapse-3" data-animate="animate__fadeIn">
                                            <price-range class="price-range">
                                                <div class="price-range-group group-range">
                                                    <input type="range" class="range" min="0" max="89" value="0"
                                                        id="range1">
                                                    <input type="range" class="range" min="0" max="89" value="89"
                                                        id="range2">
                                                </div>
                                        ...
                                        <div class="shop-sidebar sidebar-open" data-animate="animate__fadeIn">
                                            <h6 class="shop-title" data-animate="animate__fadeIn">Bộ lọc khác</h6>
                                            <a href="#collapse-6" data-bs-toggle="collapse"
                                                class="shop-title shop-title-lg">Bộ lọc khác<i
                                                    class="feather-chevron-down" data-animate="animate__fadeIn"></i></a>
                                            <div class="filter-info" data-animate="animate__fadeIn">
                                                <span class="shop-price">0 đã chọn</span>
                                                <facet-remove>
                                                    <a href="collection-list-right.html" class="reset-text">Đặt lại</a>
                                                </facet-remove>
                                            </div>
                                    ...
                                    <div class="shop-sidebar sidebar-product" data-animate="animate__fadeIn">
                                        ...
                                        <div class="filter-info">
                                            ...
                                            <facet-remove>
                                                <a href="collection.html" class="reset-text">Đặt lại</a>
                                            </facet-remove>
                                        </div>
            ...
            <a href="collection.html" class="sidebar-img banner-img">
                <span class="sidebar-banner-image">
                    <img src="{{ asset('store/image/home1/collection/side-image.jpg') }}" class="img-fluid"
                        alt="side-banner">
                </span>
...
<style>
/* No scoped - styles will apply globally */
/* Your external CSS classes will work here */
</style>

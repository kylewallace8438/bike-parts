                        ...
                        <div class="log-acc-page" id="CustomerLoginForm">
                            ...
                            <div class="section-capture">
                                <div class="section-title">
                                    <h2 data-animate="animate__fadeIn"><span>Create account</span></h2>
                                </div>
                            </div>
                            <!-- account title end -->
                            <!-- account login start -->
                                        ...
                                        <div class="login-form-container">
                                            <ul class="fill-form">
                                                <li class="log-email" data-animate="animate__fadeIn">
                                                    <label>Name</label>
                                                    <input type="text" name="q" class="input-full"
                                            ...
                                            <div class="register-action" data-animate="animate__fadeIn">
                                                <label class="cust-checkbox-label login-read-text">
                                                    <span class="login-read">I have read and agree with the <a
                                                            href="terms-condition.html">terms & condition.</a></span>
                                                    <input type="checkbox" id="login-terms" name="login-terms"
                                                        class="cust-checkbox login-checkbox">
                                                    <span class="cust-check"></span>
                                                </label>
                                                <button type="submit"
                                                    class="btn-style2 register-btn disabled">Create</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>

            ...
            <div class="section-capture">
                ...
                <ul class="nav nav-tabs">
                    @for ($i = 0; $i < count($productByCategories); $i++)
                        <li>
                            <a href="#{{ $productByCategories[$i]->slug }}" data-bs-toggle="tab"
                                class="show @if ($i == 0) active @endif">{{ $productByCategories[$i]->translation[app()->getLocale()] }}</a>
                        </li>
                    @endfor
                </ul>
            </div>
                        ...
                        <div class="collection-wrap">
                                                ...
                                                <div class="product-image">
                                                    <a href="product-template.html" class="pro-img">
                                                        <img src="{{ asset('store/image/home2/product/product-1.jpg') }}"
                                                            class="img-fluid img1 resp-img1" alt="product-1.jpg">
                                                    </a>
                            ...
                            <div class="swiper-buttons">
                                <div class="swiper-buttons-wrap">
                                    <button class="swiper-prev swiper-prev-new2"><i
                                            class="ri-arrow-left-s-line"></i></button>
                                    <button class="swiper-next swiper-next-new2"><i

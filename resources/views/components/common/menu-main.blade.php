                                    ...
                                    <div class="vegawrap collapse" id="vega-collapse2">
                                        <ul class="vega-menu">
                                            <li class="menu-link">
                                                ...
                                                <div class="menu-dropdown product-menu collapse" id="vega-laptops">
                                                    <ul class="ul">
                                            ...
                                            <li class="menu-link">
                                                ...
                                                <div class="menu-dropdown product-menu collapse" id="cosmetic2">
                                                    <ul class="ul">
                                                        <li class="productlink-li">
                                                            <a href="collection.html" class="productlink-title">
                                                                <span class="sp-link-title">Collection page</span>
                                                        ...
                                                        <li class="productlink-li menu-product">
                                                            ...
                                                            <div class="swiper" id="vega-menu-slider1">
                                ...
                                <div class="main-wrap">
                                    <ul class="main-menu">
                                        ...
                                        <li class="menu-link">
                                            ...
                                            <div class="menu-dropdown menu-single collapse" id="blogs2">
                                                <ul class="ul">
                                                    <li class="menusingle-li">

...
import img16 from '@/assets/img/car-finder/catalog/16.jpg'
...
<template>
    <div class="row">
        ...
        <div class="col-lg-8 order-lg-2 mb-5">
            <div class="d-sm-flex align-items-center justify-content-between pb-4 mb-sm-2">
                <h1 class="h3 text-light mb-sm-0 me-sm-3">Available car offers</h1>
                <div class="d-flex align-items-center">
                    <label class="fs-sm text-light me-2 pe-1 text-nowrap" for="sorting"><i class="fi-arrows-sort mt-n1 me-2"></i>Sort by:</label>
            ...
            <div class="card card-light card-hover card-horizontal mb-4">
                <div class="tns-carousel-wrapper card-img-top card-img-hover"><router-link class="img-overlay" to="/car-finder-single"></router-link>
                    ...
                    <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                        <SwiperSlide>
                            <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img14})` }"></div>
                            <SwiperSlide>
                                    <img class="d-block d-sm-none" src="@/assets/img/car-finder/catalog/14.jpg" alt="Image">
                                </SwiperSlide>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img14})` }"></div>
                ...
                <div class="card-body">
                    ...
                    <h3 class="h6 mb-1"><router-link class="nav-link-light" to="/car-finder-single">Toyota GT86</router-link></h3>
                    ...
                    <div class="border-top border-light mt-3 pt-3">
                        <div class="row g-2">
                            <div class="col me-sm-1">
                                <div class="bg-dark rounded text-center w-100 h-100 p-2"><i class="fi-dashboard d-block h4 text-light mb-0 mx-center"></i><span class="fs-xs text-light">46K mi</span></div>
                            </div>
                            <div class="col me-sm-1">
            ...
            <div class="card card-light card-hover card-horizontal mb-4">
                <div class="tns-carousel-wrapper card-img-top card-img-hover"><router-link class="img-overlay" to="/car-finder-single"></router-link>
                    ...
                    <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                        <SwiperSlide>
                            <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img15})` }"></div>
                            <SwiperSlide>
                                    <img class="d-block d-sm-none" src="@/assets/img/car-finder/catalog/15.jpg" alt="Image">
                                </SwiperSlide>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img15})` }"></div>
                ...
                <div class="card-body">
                    ...
                    <h3 class="h6 mb-1"><router-link class="nav-link-light" to="/car-finder-single">Volkswagen GTI S</router-link></h3>
                    <div class="text-primary fw-bold mb-1">$29,000</div>
                    <div class="fs-sm text-light opacity-70"><i class="fi-map-pin me-1"></i>San Francisco</div>
                    <div class="border-top border-light mt-3 pt-3">
                        <div class="row g-2">
                            <div class="col me-sm-1">
                                <div class="bg-dark rounded text-center w-100 h-100 p-2"><i class="fi-dashboard d-block h4 text-light mb-0 mx-center"></i><span class="fs-xs text-light">25K mi</span></div>
                            </div>
                            <div class="col me-sm-1">
            ...
            <div class="card card-light card-hover card-horizontal mb-4">
                <div class="tns-carousel-wrapper card-img-top card-img-hover"><router-link class="img-overlay" to="/car-finder-single"></router-link>
                    ...
                    <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                        <SwiperSlide>
                            <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img16})` }"></div>
                            <SwiperSlide>
                                    <img class="d-block d-sm-none" src="@/assets/img/car-finder/catalog/16.jpg" alt="Image">
                                </SwiperSlide>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img16})` }"></div>
                ...
                <div class="card-body">
                    ...
                    <h3 class="h6 mb-1"><router-link class="nav-link-light" to="/car-finder-single">Ford Explorer XLT</router-link></h3>
                    <div class="text-primary fw-bold mb-1">$26,900</div>
            ...
            <!-- Reviews-->
            <h1 class="h3 text-light pt-5 pb-2 mt-n3 mt-lg-n1 mb-4">Seller reviews (53)</h1>
            <!-- Reviews statistics-->
            <div class="d-flex align-items-center text-light mb-2">
                <div class="me-3"><span class="star-rating"><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i></span>
                </div>
            ...
            <div class="d-flex align-items-center text-light mb-2">
                <div class="me-3"><span class="star-rating"><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star"></i></span>
                </div>
                <div class="progress progress-light w-100">
            ...
            <div class="d-flex align-items-center text-light mb-2">
                <div class="me-3"><span class="star-rating"><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star"></i><i class="star-rating-icon fi-star"></i></span>
                </div>
                <div class="progress progress-light w-100">
            ...
            <div class="d-flex align-items-center text-light mb-2">
                <div class="me-3"><span class="star-rating"><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star"></i><i class="star-rating-icon fi-star"></i><i class="star-rating-icon fi-star"></i></span>
                </div>
                <div class="progress progress-light w-100">
            ...
            <div class="d-flex align-items-center text-light mb-2">
                <div class="me-3"><span class="star-rating"><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star"></i><i class="star-rating-icon fi-star"></i><i class="star-rating-icon fi-star"></i><i class="star-rating-icon fi-star"></i></span>
                </div>
                <div class="progress progress-light w-100">
            ...
            <div class="d-flex flex-sm-row flex-column align-items-sm-center align-items-stretch justify-content-between border-bottom border-light py-4 mt-3 mb-4">
                <div class="d-flex align-items-center me-sm-4 mb-sm-0 mb-3">
                    <label class="text-light me-2 pe-1 text-nowrap" for="review-sorting"><i class="fi-arrows-sort mt-n1 me-2"></i>Sort by:</label>
                    <select class="form-select form-select-light" id="review-sorting">
                        <option>Newest</option>
                ...
                </div><a class="btn btn-primary" href="#modal-review" data-bs-toggle="modal"><i class="fi-edit me-1"></i>Add review</a>
            </div>
            <!-- Review-->
            <div class="mb-4 pb-4 border-bottom border-light">
                <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex align-items-center pe-2"><img class="rounded-circle me-1" src="@/assets/img/avatars/06.jpg" width="48" alt="Avatar">
                        <div class="text-light ps-2">
                            <h6 class="fs-base text-light mb-0">Kristin Watson</h6><span class="star-rating"><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i></span>
                        </div>
                    </div><span class="text-light opacity-50 fs-sm">Jan 17, 2021</span>
                </div>
                ...
                <div class="d-flex align-items-center">
                    <button class="btn-like btn-light" type="button"><i class="fi-like"></i><span>(3)</span></button>
                    <div class="border-end border-light me-1">&nbsp;</div>
                    <button class="btn-dislike btn-light" type="button"><i class="fi-dislike"></i><span>(0)</span></button>
                </div>
            </div>
            <!-- Review-->
            <div class="mb-4 pb-4 border-bottom border-light">
                <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex align-items-center pe-2"><img class="rounded-circle me-1" src="@/assets/img/avatars/14.png" width="48" alt="Avatar">
                        <div class="text-light ps-2">
                            <h6 class="fs-base text-light mb-0">Darrell Steward</h6><span class="star-rating"><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star"></i><i class="star-rating-icon fi-star"></i><i class="star-rating-icon fi-star"></i></span>
                        </div>
                    </div><span class="text-light opacity-50 fs-sm">Dec 1, 2020</span>
                </div>
                <p class="text-light opacity-70">Vel dictum nunc ut tristique. Egestas diam amet, ut proin hendrerit. Dui accumsan at phasellus tempus consequat dignissim.</p>
                <div class="d-flex align-items-center">
                    <button class="btn-like btn-light" type="button"><i class="fi-like"></i><span>(0)</span></button>
                    <div class="border-end border-light me-1">&nbsp;</div>
                    <button class="btn-dislike btn-light" type="button"><i class="fi-dislike"></i><span>(1)</span></button>
                </div>
            </div>
            <!-- Review-->
            <div class="mb-4 pb-4 border-bottom border-light">
                <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex align-items-center pe-2"><img class="rounded-circle me-1" src="@/assets/img/avatars/07.jpg" width="48" alt="Avatar">
                        <div class="text-light ps-2">
                            <h6 class="fs-base text-light mb-0">Cody Fisher</h6><span class="star-rating"><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i></span>
                        </div>
                    </div><span class="text-light opacity-50 fs-sm">Oct 28, 2020</span>
                </div>
                <p class="text-light opacity-70">Viverra nunc blandit sapien non imperdiet sit. Purus tempus elementum aliquam eu urna. A aenean duis non egestas at libero porttitor integer eget. Sed dictum lobortis laoreet gravida.</p>
                <div class="d-flex align-items-center">
                    <button class="btn-like btn-light" type="button"><i class="fi-like"></i><span>(2)</span></button>
                    <div class="border-end border-light me-1">&nbsp;</div>
                    <button class="btn-dislike btn-light" type="button"><i class="fi-dislike"></i><span>(1)</span></button>
                </div>
            </div>
            ...
            <div class="mb-4 pb-4 border-bottom border-light">
                <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex align-items-center pe-2"><img class="rounded-circle me-1" src="@/assets/img/avatars/04.jpg" width="48" alt="Avatar">
                        <div class="text-light ps-2">
                            <h6 class="fs-base text-light mb-0">Ralph Edwards</h6><span class="star-rating"><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star"></i></span>
                        </div>
                    </div><span class="text-light opacity-50 fs-sm">Sep 14, 2020</span>
                </div>
                <p class="text-light opacity-70">Elementum nisl, egestas nam consectetur nisl, at pellentesque cras. Non sed ac vivamus dolor dignissim ut. Nisl sapien blandit pulvinar sagittis donec sociis ipsum arcu est. Tempus, rutrum morbi scelerisque tempor mi. Etiam urna, cras bibendum leo nec faucibus velit. Tempor lectus dignissim at auctor integer neque quam amet.</p>
                <div class="d-flex align-items-center">
                    <button class="btn-like btn-light" type="button"><i class="fi-like"></i><span>(0)</span></button>
                    <div class="border-end border-light me-1">&nbsp;</div>
                    <button class="btn-dislike btn-light" type="button"><i class="fi-dislike"></i><span>(0)</span></button>
            ...
            <div class="mb-4 pb-4 border-bottom border-light">
                <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex align-items-center pe-2"><img class="rounded-circle me-1" src="@/assets/img/avatars/14.png" width="48" alt="Avatar">
                        <div class="text-light ps-2">
                            <h6 class="fs-base text-light mb-0">Guy Hawkins</h6><span class="star-rating"><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i><i class="star-rating-icon fi-star-filled active"></i></span>
                        </div>
                    </div><span class="text-light opacity-50 fs-sm">Dec 1, 2020</span>
                </div>
                <p class="text-light opacity-70">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium dolor laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis morbi venenatis ut est.</p>
                <div class="d-flex align-items-center">
                    <button class="btn-like btn-light" type="button"><i class="fi-like"></i><span>(1)</span></button>
                    <div class="border-end border-light me-1">&nbsp;</div>
                    <button class="btn-dislike btn-light" type="button"><i class="fi-dislike"></i><span>(3)</span></button>
                </div>
            </div>
            <!-- Pagination-->
        ...
        <aside class="col-lg-4 order-lg-1 pe-xl-4 mb-5">
            <div class="d-flex align-items-start mb-4"><img class="rounded-circle" src="@/assets/img/avatars/34.jpg" width="72" alt="Devon Lane">
                <div class="ps-2">
                    <h2 class="h4 text-light mb-1">Devon Lane</h2>
                    <p class="d-flex align-items-center text-light opacity-70"><i class="fi-map-pin me-1"></i><span>Chicago, IL 60603</span></p>
                    <div class="d-flex"><a class="btn btn-icon btn-translucent-light btn-xs rounded-circle me-2" href="javascript:void(0);"><i class="fi-whatsapp"></i></a><a class="btn btn-icon btn-translucent-light btn-xs rounded-circle me-2" href="javascript:void(0);"><i class="fi-messenger"></i></a><a class="btn btn-icon btn-translucent-light btn-xs rounded-circle" href="javascript:void(0);"><i class="fi-viber"></i></a></div>
                </div>
            </div>
            <ul class="list-unstyled text-light py-2 mb-3">
                <li><strong>Available car offers: </strong><span class="opacity-70">3</span></li>
                <li><strong>Cars certified: </strong><span class="opacity-70">1</span></li>
                <li><strong>Cars sold: </strong><span class="opacity-70">2</span></li>
            </ul>
            <button class="btn btn-outline-light btn-lg px-4 mb-4" type="button"><i class="fi-phone me-2"></i>(316) *** **** – reveal</button>
            <form class="needs-validation pt-2 pb-4 mb-3" novalidate>
                <div class="mb-3">
                    <input class="form-control form-control-light" type="text" placeholder="Name*" required>
                    <div class="invalid-feedback">Please enter your name.</div>
                </div>
                <div class="mb-3">
                    <input class="form-control form-control-light" type="email" placeholder="Email*" required>
                    <div class="invalid-feedback">Provide a valid email address.</div>
                </div>
                <div class="mb-3">
                    <input class="form-control form-control-light bg-image-0" type="text" placeholder="Phone">
                </div>
                <div class="mb-3">
                    <textarea class="form-control form-control-light" rows="4" placeholder="Message*" required></textarea>
                    <div class="invalid-feedback">Write your message.</div>
                </div>
                <button class="btn btn-primary btn-lg" type="submit"><i class="fi-send me-2"></i>Send message</button>
            </form>
            <div class="card card-light card-body pb-0">
                ...
                <div class="d-flex align-items-start pt-2">
                    <div class="w-100 me-1" style="max-width: 185px;"><img src="@/assets/img/car-finder/home/mobile-app-sm.png" alt="Mobile App"></div>
                    <div class="ps-3" style="min-width: 145px;"><a class="btn-market mb-3" href="javascript:void(0);" role="button"><svg xmlns='http://www.w3.org/2000/svg' width='110' height='30' viewBox="0 0 135 28" fill='#fff'>
                            ...
                            </svg></a><br><a class="btn-market" href="javascript:void(0);" role="button"><svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='110' height='30' viewBox="0 0 140 30" fill='none'>
                                <g fill='#fff'>
    ...
    <div class="tns-carousel-wrapper tns-controls-outside-xxl tns-nav-outside tns-carousel-light">
        <swiper :autoplay="true" :slidesPerView="3" :breakpoints="swiperOptions.breakpoints" :loop="true" :spaceBetween="20" class="h-100">
            <SwiperSlide>
                <div>
                    <div class="card card-light card-hover h-100">
                        <div class="card-img-top card-img-hover"><router-link class="img-overlay" to="/car-finder-single"></router-link>
                        ...
                        <div class="card-body">
                            ...
                            <h3 class="h6 mb-1"><router-link class="nav-link-light" to="/car-finder-single">Mazda MX-5 Miata Convertible</router-link></h3>
                ...
                <div>
                    <div class="card card-light card-hover h-100">
                        ...
                        <div class="card-body">
                            ...
                            <h3 class="h6 mb-1"><router-link class="nav-link-light" to="/car-finder-single">BMW 640 XI Gran Turismo</router-link></h3>
                ...
                <div>
                    <div class="card card-light card-hover h-100">
                        ...
                        <div class="card-body">
                            ...
                            <h3 class="h6 mb-1"><router-link class="nav-link-light" to="/car-finder-single">Nissan 370Z Nismo</router-link></h3>

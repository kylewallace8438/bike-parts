...
const value = ref([25000, 65000] as [number, number]); // initial values

// Expose value to the template

import img09 from '@/assets/img/car-finder/catalog/09.jpg'
import img10 from '@/assets/img/car-finder/catalog/10.jpg'
import img11 from '@/assets/img/car-finder/catalog/11.jpg'
import img12 from '@/assets/img/car-finder/catalog/12.jpg'
import img13 from '@/assets/img/car-finder/catalog/13.jpg'
                ...
                <div class="offcanvas-lg offcanvas-start bg-dark" id="filters-sidebar">
                    ...
                    <div class="offcanvas-body py-lg-4">
                        ...
                        <div class="pb-4 mb-2">
                            ...
                            <simplebar class="overflow-auto simplebar-wrapper" data-simplebar data-simplebar-auto-hide="false" data-simplebar-inverse style="height: 11rem;">
                        ...
                        <div class="pb-4 mb-2">
                            <h3 class="h6 text-light pb-5">Price</h3>
                            <Slider v-model="value" :min="4000" :max="100000" :interval="1000" :tooltip="'always'" :hide-labels="false" :format="{ prefix: '$', decimals: 0 }" />

                            <div class="form-check form-switch form-switch-light pt-4">
                            ...
                            <div class="d-flex align-items-center pt-3">
                                <div class="w-50 pe-2">
                                    <input class="form-control form-control-light range-slider-value-min" value="25000" type="text">
                                </div>
                                <div class="text-muted">—</div>
                                <div class="w-50 ps-2">
                                    <input class="form-control form-control-light range-slider-value-max" value="65000" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="pb-4 mb-2">
                        ...
                        <div class="pb-4 mb-2">
                            ...
                            <simplebar class="overflow-auto" data-simplebar data-simplebar-auto-hide="false" data-simplebar-inverse style="height: 11rem;">
                                <div class="form-check form-check-light">
            ...
            <div class="col-lg-9">
                ...
                <div class="d-sm-flex align-items-center justify-content-between pb-4 mb-2">
                    ...
                    <div class="d-none d-sm-flex">
                        <router-link class="nav-link nav-link-light px-2 active" to="/car-finder-catalog-list" data-bs-toggle="tooltip" title="List view">
                            <i class="fi-list"></i>
                        </router-link>
                        <router-link class="nav-link nav-link-light px-2" to="/car-finder-catalog-grid" data-bs-toggle="tooltip" title="Grid view">
                            <i class="fi-grid"></i>
                        </router-link>
                    </div>
                </div>
                ...
                <div class="card card-light card-hover card-horizontal mb-4">
                    <div class="tns-carousel-wrapper card-img-top card-img-hover">
                        ...
                        <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                            <SwiperSlide>
                                <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img09})` }"></div>
                                <SwiperSlide>
                                    <img class="d-block d-sm-none" src="@/assets/img/car-finder/catalog/09.jpg" alt="Image">
                                </SwiperSlide>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img09})` }"></div>
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="h6 mb-1">
                            <router-link class="nav-link-light" to="/car-finder-single">Ford Truck Lifted</router-link>
                        </h3>
                ...
                <div class="card card-light card-hover card-horizontal mb-4">
                    <div class="tns-carousel-wrapper card-img-top card-img-hover">
                        <router-link class="img-overlay" to="/car-finder-single"></router-link>
                        <div class="position-absolute start-0 top-0 pt-3 ps-3">
                            <span class="d-table badge bg-info mb-1">Used</span>
                        ...
                        <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                            <SwiperSlide>
                                <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img10})` }"></div>
                                <SwiperSlide>
                                    <img class="d-block d-sm-none" src="@/assets/img/car-finder/catalog/10.jpg" alt="Image">
                                </SwiperSlide>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img10})` }"></div>
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="h6 mb-1">
                            <router-link class="nav-link-light" to="/car-finder-single">Mercedes Benz C300 Sport</router-link>
                        </h3>
                        <div class="text-primary fw-bold mb-1">$53,400</div>
                        ...
                        <div class="border-top border-light mt-3 pt-3">
                            <div class="row g-2">
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">
                                        <i class="fi-dashboard d-block h4 text-light mb-0 mx-center"></i>
                                        <span class="fs-xs text-light">35K mi</span>
                                    </div>
                                </div>
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">
                                ...
                                <div class="col">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">
                                        <i class="fi-petrol d-block h4 text-light mb-0 mx-center"></i>
                                        <span class="fs-xs text-light">Hybrid</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card card-light card-hover card-horizontal mb-4">
                    <div class="tns-carousel-wrapper card-img-top card-img-hover">
                        ...
                        <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                            <SwiperSlide>
                                <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img11})` }"></div>
                                <SwiperSlide>
                                    <img class="d-block d-sm-none" src="@/assets/img/car-finder/catalog/11.jpg" alt="Image">
                                </SwiperSlide>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img11})` }"></div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-primary fw-bold mb-1">$36,500</div>
                        <div class="fs-sm text-light opacity-70">
                        ...
                        <div class="border-top border-light mt-3 pt-3">
                            <div class="row g-2">
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">
                                        <i class="fi-dashboard d-block h4 text-light mb-0 mx-center"></i>
                                        <span class="fs-xs text-light">18K mi</span>
                                    </div>
                                </div>
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">
                ...
                <div class="card card-light card-hover card-horizontal mb-4">
                    <div class="tns-carousel-wrapper card-img-top card-img-hover">
                        ...
                        <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                            <SwiperSlide>
                                <div class="bg-size-cover bg-position-center w-100 h-100  d-sm-block d-none" :style="{ 'background-image': `url(${img12})` }"></div>
                                <SwiperSlide>
                                    <img class="d-block d-sm-none" src="@/assets/img/car-finder/catalog/12.jpg" alt="Image">
                                </SwiperSlide>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img12})` }"></div>
                        ...
                        <div class="border-top border-light mt-3 pt-3">
                            <div class="row g-2">
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">
                                        <i class="fi-dashboard d-block h4 text-light mb-0 mx-center"></i>
                                        <span class="fs-xs text-light">16K mi</span>
                                    </div>
                                </div>
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">
                ...
                <div class="card card-light card-hover card-horizontal mb-4">
                    <div class="tns-carousel-wrapper card-img-top card-img-hover">
                        ...
                        <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                            <SwiperSlide>
                                <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img13})` }"></div>
                                <SwiperSlide>
                                    <img class="d-block d-sm-none" src="@/assets/img/car-finder/catalog/13.jpg" alt="Image">
                                </SwiperSlide>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div class="bg-size-cover bg-position-center w-100 h-100 d-sm-block d-none" :style="{ 'background-image': `url(${img13})` }"></div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-primary fw-bold mb-1">$44,300</div>
                        <div class="fs-sm text-light opacity-70">
                        ...
                        <div class="border-top border-light mt-3 pt-3">
                            <div class="row g-2">
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2"><i class="fi-dashboard d-block h4 text-light mb-0 mx-center"></i>
                        ...
                        <div class="border-top border-light mt-3 pt-3">
                            <div class="row g-2">
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">
                                        <i class="fi-dashboard d-block h4 text-light mb-0 mx-center"></i>
                                        <span class="fs-xs text-light">46K mi</span>
                                    </div>
                                </div>
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">
                        ...
                        <div class="border-top border-light mt-3 pt-3">
                            <div class="row g-2">
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">
                                        <i class="fi-dashboard d-block h4 text-light mb-0 mx-center"></i>
                                        <span class="fs-xs text-light">25K mi</span>
                                    </div>
                                </div>
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">
                ...
                <div class="card card-light card-hover card-horizontal mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between pb-1">
                            ...
                            <div class="form-check form-check-light">
                                <input class="form-check-input" type="checkbox" id="compare8">
                                <label class="form-check-label fs-sm" for="compare8">Compare</label>
                            </div>
                        </div>
                        ...
                        <div class="border-top border-light mt-3 pt-3">
                            <div class="row g-2">
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">
                                        <i class="fi-dashboard d-block h4 text-light mb-0 mx-center"></i>
                                        <span class="fs-xs text-light">34K mi</span>
                                    </div>
                                </div>
                                <div class="col me-sm-1">
                                    <div class="bg-dark rounded text-center w-100 h-100 p-2">

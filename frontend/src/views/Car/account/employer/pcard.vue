        ...
        <div class="col-lg-8 order-lg-2 mb-5">
            ...
            <div class="card bg-secondary card-hover mb-2">
                <div class="card-body">
                    ...
                    <div class="fs-sm">
                        <span class="text-nowrap me-3"><i class="fi-map-pin text-muted me-1"> </i>New Jersey</span>
                        <span class="text-nowrap me-3"><i class="fi-cash fs-base text-muted me-1"></i>$8,000</span>
                    </div>
                </div>
            </div>
            <!-- Item-->
                ...
                <div class="card-body">
                    ...
                    <div class="fs-sm">
                        <span class="text-nowrap me-3">
                            <i class="fi-map-pin text-muted me-1"> </i>New York
                        </span><span class="text-nowrap me-3">
                            <i class="fi-cash fs-base text-muted me-1"></i>$5,000
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex flex-sm-row flex-column align-items-sm-center align-items-stretch justify-content-between border-bottom py-4 mt-3 mb-4">
                <div class="d-flex align-items-center me-sm-4 mb-sm-0 mb-3">
                    <label class="me-2 pe-1 text-nowrap" for="review-sorting">
                ...
                <a class="btn btn-outline-primary rounded-pill" href="#modal-review" data-bs-toggle="modal">
            ...
            <div class="mb-4 pb-4 border-bottom">
                <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex align-items-center pe-2">
                        <img class="rounded-circle me-1" src="@/assets/img/avatars/13.png" width="48" alt="Avatar">
                        <div class="ps-2">
                            <h6 class="fs-base mb-0">Guy Hawkins</h6><span class="star-rating">
                                <i class="star-rating-icon fi-star-filled active"></i>
                                <i class="star-rating-icon fi-star-filled active"></i>
                                <i class="star-rating-icon fi-star-filled active"></i>
                                <i class="star-rating-icon fi-star-filled active"></i>
            ...
            <div class="pt-sm-3">
                <div class="card bg-secondary border-0">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Create a great resume on Finder and take a step toward finding your dream job!</p>
                        <router-link class="btn btn-primary rounded-pill mb-4" to="/job-board-post-resume-1">Post resume

                ...
                <div class="offcanvas-lg offcanvas-start bg-dark" id="filters-sidebar">
                    ...
                    <div class="offcanvas-header bg-transparent d-block border-bottom border-light pt-0 pt-lg-4 px-lg-0">
                        <ul class="nav nav-tabs nav-tabs-light mb-0">
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:void(0);">Search New</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="javascript:void(0);">Search Used</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="pb-4 mb-2">
                            ...
                            <div class="range-slider range-slider-light mb-3" data-start-min="25000" data-start-max="65000" data-min="4000" data-max="100000" data-step="1000">
                                <div class="d-flex align-items-center mt-4">
                                    <div class="w-50 pe-2">
                                        <input class="form-control form-control-light range-slider-value-min" placeholder="25000" type="text">
                                    </div>
                                    <div class="text-muted">&mdash;</div>
                                    <div class="w-50 ps-2">
                                        <input class="form-control form-control-light range-slider-value-max" placeholder="65000" type="text">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-9">
                ...
                <div class="d-sm-flex align-items-center justify-content-between pb-4 mb-2">
                    ...
                    <div class="d-none d-sm-flex">
                        <router-link class="nav-link nav-link-light px-2" to="/car-finder-catalog-list" data-bs-toggle="tooltip" title="List view">
                            <i class="fi-list"></i>
                        </router-link>
                        <router-link class="nav-link nav-link-light px-2 active" to="/car-finder-catalog-grid" data-bs-toggle="tooltip" title="Grid view">
                            <i class="fi-grid"></i>
                        </router-link>
                    </div>
                </div>
                        ...
                        <div class="card card-light card-hover h-100">
                            <div class="tns-carousel-wrapper card-img-top card-img-hover">
                                ...
                                <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/01.jpg" alt="Image">
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/01.jpg" alt="Image">
                                    </SwiperSlide>
                    ...
                    <div class="col-sm-6 mb-4">
                        <div class="card card-light card-hover h-100">
                            <div class="tns-carousel-wrapper card-img-top card-img-hover">
                                ...
                                <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/02.jpg" alt="Image">
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/02.jpg" alt="Image">
                                    </SwiperSlide>
                    ...
                    <div class="col-sm-6 mb-4">
                        <div class="card card-light card-hover h-100">
                            <div class="tns-carousel-wrapper card-img-top card-img-hover">
                                ...
                                <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/03.jpg" alt="Image">
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/03.jpg" alt="Image">
                                    </SwiperSlide>
                    ...
                    <div class="col-sm-6 mb-4">
                        <div class="card card-light card-hover h-100">
                            <div class="tns-carousel-wrapper card-img-top card-img-hover">
                                ...
                                <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/04.jpg" alt="Image">
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/04.jpg" alt="Image">
                                    </SwiperSlide>
                    ...
                    <div class="col-sm-6 mb-4">
                        <div class="card card-light card-hover h-100">
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="h6 mb-1">
                                    <router-link class="nav-link-light" to="/car-finder-single">BMW 640 XI Gran Turismo</router-link>
                                </h3>
                    ...
                    <div class="col-sm-6 mb-4">
                        <div class="card card-light card-hover h-100">
                            <div class="tns-carousel-wrapper card-img-top card-img-hover">
                                ...
                                <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/06.jpg" alt="Image">
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/06.jpg" alt="Image">
                                    </SwiperSlide>
                    ...
                    <div class="col-sm-6 mb-4">
                        <div class="card card-light card-hover h-100">
                            <div class="tns-carousel-wrapper card-img-top card-img-hover">
                                ...
                                <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/07.jpg" alt="Image">
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/07.jpg" alt="Image">
                                    </SwiperSlide>
                    ...
                    <div class="col-sm-6 mb-4">
                        <div class="card card-light card-hover h-100">
                            <div class="tns-carousel-wrapper card-img-top card-img-hover">
                                ...
                                <swiper :autoplay="true" :slidesPerView="1" :loop="true" class="h-100">
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/08.jpg" alt="Image">
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img src="@/assets/img/car-finder/catalog/08.jpg" alt="Image">
                                    </SwiperSlide>
                ...
                <div class="d-flex align-items-center justify-content-between py-2">
                    <div class="d-flex align-items-center me-sm-4">
                        ...
                        <div class="d-none d-md-block fw-bold text-light opacity-70 text-nowrap ps-md-4">
                            ...
                            <span class="align-middle">Compare (0)</span>
                        </div>
                    </div>
